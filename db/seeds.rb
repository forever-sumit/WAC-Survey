...
s1_q1 = section.questions.create(question_title: 'Was the person asking the questions a professionally trained enumerator?', in_order: 1, serial_number: 1.1)
...
s1_q2 = section.questions.create(question_title: 'Was the person asking the questions a potential friend or neighbour?', in_order: 2, serial_number: 1.2)
...
s1_q3 = section.questions.create(question_title: 'What the person collecting the questions the same gender as the respondent?', in_order: 3, serial_number: 1.3)
...
s1_q4 = section.questions.create(question_title: 'Was the person asking the questions of a higher status than the respondent, lower status than the respondent or same status?', in_order: 4, serial_number: 1.4)
...
s2_q1 = section.questions.create(question_title: 'Who was present during the data collection other than the respondent?', in_order: 1, serial_number: 2.1)
...
s2_q2 = section.questions.create(question_title: 'How were respondents selected?', in_order: 2, serial_number: 2.2)
...
s2_q3 = section.questions.create(question_title: 'Were selected respondents followed-up with repeatedly until they answered?', in_order: 3, serial_number: 2.3)
...
s2_q4 = section.questions.create(question_title: 'Were respondents selected based on the data collector’s choices?', in_order: 4, serial_number: 2.4)
...
s2_q5 = section.questions.create(question_title: 'Were respondents selected based on their external characteristics?', in_order: 5, serial_number: 2.5)
...
s3_q1 = section.questions.create(question_title: 'Does the data include a record of respondents who declined to participate?', in_order: 1, serial_number: 3.1)
...
s3_q2 = section.questions.create(question_title: 'What groups of people were intentionally not included?', in_order: 2, serial_number: 3.2)
...
s3_q3 = section.questions.create(question_title: 'What groups of people were accidentally not included?', in_order: 3, serial_number: 3.3)
...
s4_q1 = section.questions.create(question_title: 'In what format was the gender question asked?', in_order: 1, serial_number: 4.1)
...
s4_q2 = section.questions.create(question_title: 'How was the household status question asked?', in_order: 2, serial_number: 4.2)
...
s4_q3 = section.questions.create(question_title: 'How was the marriage/partnership question asked?', in_order: 3, serial_number: 4.3)
...
s4_q4 = section.questions.create(question_title: 'How was the work question asked?', in_order: 4, serial_number: 4.4)
...
s4_q5 = section.questions.create(question_title: 'Were any questions were answered by the enumerator rather than directly by the respondents', in_order: 5, serial_number: 4.5)
...
s4_q6 = section.questions.create(question_title: 'Do the skip patterns used introduce potential bias?', in_order: 6, serial_number: 4.6)
...
s5_q1 = section.questions.create(question_title: 'Where was the data collected?', in_order: 1, serial_number: 5)
...
s5_q2 = section.questions.create(question_title: 'Who has access to the final data?', in_order: 2, serial_number: 6)
...
s5_q3 = section.questions.create(question_title: 'Is the place where the data was collected a place that raises or diminishes the respondent’s status?', in_order: 3, serial_number: 7)
...
s6_q1 = section.questions.create(question_title: 'What tools/technology was used to collect the data', in_order: 1, serial_number: 8)
...
s6_q3 = section.questions.create(question_title: 'What incentivization was offered for data collection?', in_order: 3, serial_number: 10)
...
s6_q4 = section.questions.create(question_title: 'What level of ownership are the data producers being given?', in_order: 4, serial_number: 11)
...
s6_q5 = section.questions.create(question_title: 'What type of results are given to the data respondents?', in_order: 5, serial_number: 12)
...
s6_q6 = section.questions.create(question_title: 'Was any part of this data taken from administrative databases?', in_order: 6, serial_number: 13)
...
s7_q1 = section.questions.create(question_title: 'What is the primary data collection purpose?', in_order: 1, serial_number: 14)
...
s7_q2 = section.questions.create(question_title: 'What is the secondary data collection purpose?', in_order: 2, serial_number: 15)
...
s7_q3 = section.questions.create(question_title: 'Is there an economic advantage (to data collectors) to the numbers skewing in a particular direction?', in_order: 3, serial_number: 16)
...
s7_q4 = section.questions.create(question_title: 'Is there an political advantage (to data collectors) to the numbers skewing in a particular direction?', in_order: 4, serial_number: 17)
...
s7_q5 = section.questions.create(question_title: 'Is there an personal advantage (to data collectors) to the numbers skewing in a particular direction?', in_order: 5, serial_number: 18)
...
s7_q6 = section.questions.create(question_title: 'Is there an economic advantage (to respondents) to the numbers skewing in a particular direction?', in_order: 6, serial_number: 19)
...
s7_q7 = section.questions.create(question_title: 'Is there an political advantage (to respondents) to the numbers skewing in a particular direction?', in_order: 7, serial_number: 20)
...
s7_q8 = section.questions.create(question_title: 'Is there an personal advantage (to respondents) to the numbers skewing in a particular direction?', in_order: 8, serial_number: 21)
...
s7_q9 = section.questions.create(question_title: 'Is this data collected in connection with eligibility for a benefit?', in_order: 9, serial_number: 22)
...
s7_q10 = section.questions.create(question_title: 'Is this data collected by the government?', in_order: 10, serial_number: 23)
...
s7_q11 = section.questions.create(question_title: 'Is this data collected by an NGO?', in_order: 11, serial_number: 24)
...
s7_q12 = section.questions.create(question_title: 'Is this data collected with a blinding process?', in_order: 12, serial_number: 25)
...
s7_q13 = section.questions.create(question_title: 'Is this data collected with informed consent?', in_order: 13, serial_number: 26)
...
s8_q1 = section.questions.create(question_title: 'Has the data been cleaned', in_order: 1, serial_number: 27)
...
s8_q2 = section.questions.create(question_title: 'Have anomalies or outliers been accounted for or removed', in_order: 2, serial_number: 28)
...
s8_q3 = section.questions.create(question_title: 'Has missing data been deleted?', in_order: 3, serial_number: 29)
s8_q3.answers.create(answer_title: 'Yes, questions with lots of missing data were deleted', answer_score: 3)
s8_q3.answers.create(answer_title: 'Yes, any respondent without totally complete data was deleted', answer_score: 3)
s8_q3.answers.create(answer_title: 'No', answer_score: 1)
s8_q3.answers.create(answer_title: 'Unsure', answer_score: 99)